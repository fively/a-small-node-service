 ...
 */
export function getModelToken(model: Function, connection: KnexModuleOptions | string = DEFAULT_CONNECTION_NAME) {
 ...
 */
export function getConnectionPrefix(connection: KnexModuleOptions | string = DEFAULT_CONNECTION_NAME): string {
